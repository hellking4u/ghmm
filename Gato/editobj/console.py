...
class Console(Frame):
    def __init__(self, parent=None, dict={}, globals={}, **options):
        ...
        self.startup = "Python Console v%s by Ka-Ping Yee <ping@lfw.org>\n" % VERSION
        self.dict    = dict
    ...
    def cb_help(self, event):
        ...
        try:
            parent = eval(context[:-1], self.dict, self.globals)
        except: pass
    ...
    def run(self, code):
        ...
        try:
            exec code in self.dict, self.globals
        except:
            self.error = 1
...
# Use the more powerfull "attrs_of" function of editobj instead.
# This one can figure out attributes defined by properties, or at the C level.
from editobj import attrs_of as members
